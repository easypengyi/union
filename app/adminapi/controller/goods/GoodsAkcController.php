...
class GoodsAkcController
{
    ...
    public function queryPaylist()
    {
        ...
        //
        $params =array();
        $result = (new OrderLogic())->queryPaylist($params);
        if (false === $result) {
    ...
    public function deliveryakc($params =array())
    {
    ...
    //同意退款
    public function agreeRefund($params =array())
    {
        $result = (new AfterSaleLogic())->confirmRefundAkc($params);
        return $result;
    }
    //拒绝
    public function Afterrefuse($params =array())
    {
        $result = (new AfterSaleLogic())->refuse($params);
        return $result;
    }
    /**
     * @notes 添加商品
    ...
    public function add_temp($params)
    {
        //print_r($params);
        //$params = $this->request->post();
        if (GoodsEnum::SEPC_TYPE_MORE == $params['spec_type']) {
        ...
        $check = (new GoodsValidate())->checkAkcGoods($params['code'],array(),array());
