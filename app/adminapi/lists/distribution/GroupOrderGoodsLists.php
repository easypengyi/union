 ...
 */
class GroupOrderGoodsLists extends BaseAdminDataLists implements ListsSearchInterface,ListsExcelInterface
{
    /**
     * @notes 设置搜索条件
     * @return array
    ...
    public function setExcelFields(): array
    {
        return [
            ...
            'distribution_member_sn' => '运营商编号',
            'distribution_member_nickname' => '运营商商昵称',
            'ratio' => '佣金比例',
            'earnings' => '佣金金额',
            'status_desc' => '佣金状态',
