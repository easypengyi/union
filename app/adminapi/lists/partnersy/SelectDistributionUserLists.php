 ...
 */
class SelectDistributionUserLists extends BaseAdminDataLists implements ListsSearchInterface
{
    /**
     * @notes 设置搜索
     * @return \string[][]
    ...
    public function lists(): array
    {
        ...
        $lists = User::alias('u')
            ...
            ->field($field)
            ->where('d.is_distribution',1)
            ->where('u.inviter_id','in',[0,$this->params['partnersy_user_id']])
