 ...
 */
class PartnersyFansLists extends BaseShopDataLists
{
    /**
     * @notes 粉丝列表
     * @return array
    ...
    public function lists(): array
    {
        ...
        $lists = User::alias('a')
            ...
            ->field('a.id,a.avatar,a.nickname,a.mobile, a.create_time, a.id as fans, a.id as order_amount,a.id as order_num')
            ->where($where)
    ...
    public function setWhere()
    {
        ...
        switch ($type) {
            ...
            // 默认
            default:
                $where[] = ['a.partnersy_user_id', '=', $this->userId];
                $where[] = ['b.is_distribution', '=', 1];
        }
        // 关键字搜索
